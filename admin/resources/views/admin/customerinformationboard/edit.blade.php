	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
					<h4>
						Customer Information Board Edit
					</h4>
					<form method="POST" id="infoBoardEditForm" name="info_board_edit" action="{{ route ('customerinformationboard.update',[$info_board['id'],'type' => 'informationBoard']) }} " enctype="multipart/form-data">  
        				@method('PUT')
						@csrf
						<div class="row">
							<div class="col-md-6">
...
<script language="javascript" type="text/javascript">
	...
	$("#infoBoardEditForm").validate({
		rules: {
			info_board_text_edit: {
				required: true,	
			}
		},
		messages: {
