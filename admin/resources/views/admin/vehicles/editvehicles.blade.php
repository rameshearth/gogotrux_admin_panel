        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input id="veh_model_name" type="text" class="form-control" name="veh_model_name" value="" required autofocus>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input id="veh_type_name" type="text" class="form-control" name="veh_type_name" value="" required autofocus>
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <input id="is_active" type="checkbox" name="is_active" value="1" required autofocus>
