	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
					<h4>
						Information Board Add
					</h4>
					<form method="POST" id="infoBoardForm" name="info_board" action="{{ route ('informationboard/store') }} ">  
					@csrf
						<div class="row">
							<div class="col-md-6">
								<label for="info_board_text" class="control-label">Information Board Text:</label>
