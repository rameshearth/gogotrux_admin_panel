    ...
    public function index()
    {
        if (! Gate::allows('information_manage'))
        {
            ...
            $operators_emails = Operator::select('op_email')->whereNull('deleted_at')->get();
                $header = "All Operators Numbers And Emails";
            
            return view('admin.information.index', ['operators_numbers' => $operators_numbers,'operators_emails' => $operators_emails, 'header' => $header]);
        }
    }
